...
import com.nicebao.springboot.entity.Logistics;
import com.nicebao.springboot.entity.Order;
import com.nicebao.springboot.entity.OrderBatchRequest;
import com.nicebao.springboot.entity.dto.OrderAddressUpdateDTO;
...
import com.nicebao.springboot.service.OrderService;
...
public class OrderController {
    ...
    public Result<Order> updateOrderStatus(@PathVariable Long id, @RequestParam Integer status) {
        ...
        if (UserRole.isUser(role)) {
            ...
            // 农户只能：取消待支付订单（状态4）或确认收货（状态3，且原状态必须是已发货2）
