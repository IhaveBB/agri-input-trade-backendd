...
import com.nicebao.springboot.service.StockWarningService;
import com.nicebao.springboot.service.StockWarningService.StockWarningDTO;
import com.nicebao.springboot.service.StockWarningService.StockWarningOverview;
...
public class StockWarningController {
    ...
    public Result<Integer> getWarningCount() {
        ...
        if (UserContext.isAdmin()) {
            ...
            count = stockWarningService.getWarningCount(UserContext.getUserId());
        } else {
            count = 0;
        }
