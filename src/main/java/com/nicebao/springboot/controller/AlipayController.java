...
import com.nicebao.springboot.service.AlipayService;
import com.nicebao.springboot.service.BalanceService;
...
public class AlipayController {
    ...
    public String paymentNotify(HttpServletRequest request) throws Exception {
        return alipayService.handlePaymentNotify(request) ? "success" : "failure";
    }
}
